...
function main() {
     ...
     * @param {string} memo
     */
    const appendRecord = ({ date, to, amount, URL, memo }) => {
     ...
     * @param {Date} today
     */
    const matchYears = (diff, startDate, today) => {
     ...
     * @param {Date} today
     */
    const matchMonths = (diff, startDate, today) => {
     ...
     * @param {Date} today
     */
    const matchDays = (diff, startDate, today) => {
        const todayDay = dayjs(today);
