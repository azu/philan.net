...
export const env = {
    ...
    CLIENT_ID: ENABLE_PRODUCTION_DATA ? process.env.APP_PROD_CLIENT_ID! : process.env.APP_CLIENT_ID!,
    CLIENT_SECRET: ENABLE_PRODUCTION_DATA ? process.env.APP_PROD_CLIENT_SECRET! : process.env.APP_CLIENT_SECRET!,
